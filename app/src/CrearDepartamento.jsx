...
function CrearDepartamento(){
    ...
    async function guardar(event){
        event.preventDefault()
            await fetch('https://skojryaxbquqtwvuyhfv.supabase.co/rest/v1/departamento?select=*',{
                method: "POST",
                headers:{
                ...
                body:JSON.stringify({nombre:nombre,descripcion:descripcion,empresa_id:idemp})
            })
    }
    return(
        <div>
            ...
            <form onSubmit={guardar}>
                ...
                <input type="text" placeholder="Id Empresa" onChange={(event) => setIdemp(event.target.value)}/>
